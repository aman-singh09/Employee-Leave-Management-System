...
<input placeholder="" id="mask1" name="fromdate" type="date" class="datepicker" autocomplete="off" >
</div>
<div class="input-field col m6 s12">
<label for="todate">To Date</label>
<input placeholder="" id="mask1" name="todate" type="date" class="datepicker" autocomplete="off" >
</div>
