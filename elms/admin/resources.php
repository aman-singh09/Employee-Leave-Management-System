    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Availability List</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Temporary Resources</span>
                                ...
                                <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
<?php $sql = "SELECT tblemployees.EmpId as empid,tblemployees.Firstname as fname,tblemployees.Lastname as lname,tblemployees.Department as Department,tblresources.availability as avail from tblresources,tblemployees where tblemployees.EmpId=tblresources.EmpId";
$query = $dbh -> prepare($sql);
$query->execute();
